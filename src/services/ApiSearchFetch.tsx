...
export const fetchByName = async (searchTerm: string) => {
  try {
    const response = await fetch(`${baseURL}dbee67cfeb85944498c21189ae4544b7/search/${searchTerm}`);
...
export const fetchById = async (id: string) => {
  try {
    const response = await fetch(`${baseURL}dbee67cfeb85944498c21189ae4544b7/${id}`);
    const data = await response.json();
    return data;
  } catch (error) {
